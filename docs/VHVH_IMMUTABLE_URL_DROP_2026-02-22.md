# VhVH Immutable URL Drop (Gate-Clear Packet)

Supersession: This one-drop packet supersedes prior VhVH pre-bundles and pending placeholders. Use only SHA-pinned URLs listed here.

## 1) Decision artifact (signer + UTC + APPROVE/WITHHOLD)
- https://github.com/mgnlia/kidrunner-android-prototype/blob/c5c4a0e1c09995cb09df9fcc9fed0a51bd0503d9/docs/VHVH_DECISION_ARTIFACT_2026-02-22.md

Decision summary (from artifact):
- Signer: Dev (AI Office)
- Decision UTC: 2026-02-22T15:18:30Z
- Decision: WITHHOLD

## 2) Families / Play declaration URLs
- https://github.com/mgnlia/kidrunner-android-prototype/blob/f3805347ba25964ba5b977659f9f2a7b693bd2c5/docs/POLICY_MAPPING.md

## 3) AdMob declaration URLs
